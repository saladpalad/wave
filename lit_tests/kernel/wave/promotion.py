...
def test_read_write_equal_sizes():
    ...
    # CHECK-NEXT: %write_1
    # CHECK-SAME: (%read, %allocate, 4, None, (), None, False, None, None)
    # CHECK-NEXT: %read_1
    # CHECK-SAME: (%allocate, 4, None, (), None, False, None, None, [%write_1])
    # CHECK-NEXT: %write
    # CHECK-SAME: (%read_1, %c, 4, None, (), None, False, None, None)
...
def test_gemm():
    ...
    # CHECK-NEXT: iterate
    # CHECK-NEXT: %write
    # CHECK-SAME: (%iterate, %c, 4, None, (), None, False, None, None)
    ...
    # CHECK-SAME: (%read, %allocate, 4, None, (), None, False, None, None)
    # CHECK-NEXT: %read_2
    # CHECK-SAME: (%allocate, 4, None, (), None, False, None, None, [%write])
    # CHECK-NEXT: %read_1
    # CHECK-NEXT: %write_1
    # CHECK-SAME: (%read_1, %allocate_1, 4, None, (), None, False, None, None)
    # CHECK-NEXT: %read_3
    # CHECK-SAME: (%allocate_1, 4, None, (), None, False, None, None, [%write_1])
    # CHECK-NEXT: %mma
