...
def test_read_write_equal_sizes():
    ...
    # CHECK-SAME: (%read_M:0_N:0, %allocate, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_1_shared_M:0_N:1
    # CHECK-SAME: (%read_M:0_N:1, %allocate, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_1_shared_M:1_N:0
    # CHECK-SAME: (%read_M:1_N:0, %allocate, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_1_shared_M:1_N:1
    # CHECK-SAME: (%read_M:1_N:1, %allocate, 4, None, (), None, 0, None, None)
    ...
    # CHECK-SAME: (%read_1_shared_M:0_N:0, %c, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_M:0_N:1
    # CHECK-SAME: (%read_1_shared_M:0_N:1, %c, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_M:1_N:0
    # CHECK-SAME: (%read_1_shared_M:1_N:0, %c, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: %write_M:1_N:1
    # CHECK-SAME: (%read_1_shared_M:1_N:1, %c, 4, None, (), None, 0, None, None)
