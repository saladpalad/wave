...
def test_read_write_equal_sizes():
    ...
    # CHECK-SAME: (%allocate, 4, None, (), None, 0, None, None, [%write_1_shared_M:0_N:0]
    # CHECK-NEXT: %read_1_shared_M:0_N:1
    # CHECK-SAME: (%allocate, 4, None, (), None, 0, None, None, [%write_1_shared_M:0_N:1]
    # CHECK-NEXT: %read_1_shared_M:1_N:0
    # CHECK-SAME: (%allocate, 4, None, (), None, 0, None, None, [%write_1_shared_M:1_N:0]
    # CHECK-NEXT: %read_1_shared_M:1_N:1
    # CHECK-SAME: (%allocate, 4, None, (), None, 0, None, None, [%write_1_shared_M:1_N:1]
