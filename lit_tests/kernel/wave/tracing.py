...
def test_trace_py_arithmetic():
    ...
    # CHECK: %a
    # CHECK-NEXT: %read
    # CHECK-SAME: (%a, None, None, (), None, 0, None, None, None)
    # CHECK-NEXT: %add
    ...
    # CHECK-SAME: (%sub,)
    # CHECK-NEXT: %write
    # CHECK-SAME: (%neg, %a, 4, None, (), None, 0, None, None)
    # CHECK-NEXT: return None
    ...
    # CHECK-NEXT: write(register_=neg, memory=a, elements_per_thread=4, mapping_dynamic_vals=(), flags=0)
    # CHECK-NEXT: output
