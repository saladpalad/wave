...
def test_trace_py_arithmetic():
    ...
    # CHECK: %a
    # CHECK-NEXT: %read
    # CHECK-SAME: (%a, None, None, (), None, False, None, None, None)
    # CHECK-NEXT: %add
    ...
    # CHECK-SAME: (%sub,)
    # CHECK-NEXT: %write
    # CHECK-SAME: (%neg, %a, 4, None, (), None, False, None, None)
    # CHECK-NEXT: return None
    ...
    # CHECK-NEXT: write(register_=neg, memory=a, elements_per_thread=4, mapping_dynamic_vals=(), volatile=False)
    # CHECK-NEXT: output
